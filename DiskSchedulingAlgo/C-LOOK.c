...
int clook(int request_queue[] , int seek_sequence[] , int current_head_pos , int n , int direction , int mx_track)
{
...
int main(){
    ...
    TotalSeekTime = clook(request_queue , seek_sequence , head , n , direction , mx_track);
