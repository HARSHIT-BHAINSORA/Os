...
int look(int request_queue[] , int seek_sequence[] , int current_head_pos , int n , int direction , int mx_track)
{
...
int main(){
    ...
    TotalSeekTime = look(request_queue , seek_sequence , head , n , direction , mx_track);
